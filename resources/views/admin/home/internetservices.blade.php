    ...
    <div class="main-content">
        ...
        <div class="container">
            ...
            <!-- end::page-header -->
                    ...
                    <form method="POST" action="{{route('home.internetservices.update',$home)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="section_two_status" class="form-control" id="exampleFormControlSelect1">

                                                        <option value="1" {{$home->section_two_status == 1 ? 'selected' : ''}}>Yes</option>
                                                        <option value="0" {{$home->section_two_status == 0 ? 'selected' : ''}}>No</option>
                                                    </select>

                                                </div>
                                                @error('section_two_status')
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Main Heading</label>
                                                        <input type="text" name="section_two_short_heading" class="form-control" id="exampleInputEmail1"
                                                               aria-describedby="emailHelp" placeholder="Enter Facebook Link" value="{{$home->section_two_short_heading}}">

                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Title</label>
                                                    <input type="text" name="section_two_main_heading" class="form-control" id="exampleInputEmail1"
                                                               aria-describedby="emailHelp" placeholder="Enter Instagram Link" value="{{$home->section_two_main_heading}}">
